...
public class Bot {
    public static void main(String[] args) {
        ...
        System.out.println("Entonces me dices que tienes " + age + " años. Yo tengo 400 años.");double ratio = 400.0;
        System.out.println("Eso quiere decir que soy " + String.format("%.2f", ratio) + " veces más vieja que tu.");
